...
public class HardcodedPrograms {
    public static final List<IStatement> hardcodedPrograms = new ArrayList<IStatement>(List.of(
            ...
            new CompositeStatement(new VariableDeclarationStatement("v1",new RefType(new IntegerType())), new CompositeStatement(new VariableDeclarationStatement("cnt",new IntegerType()), new CompositeStatement(new NewStatement("v1", new ConstantExpression(new IntegerValue(1))), new CompositeStatement(new CreateSemaphoreStatement("cnt", new ReadHeapFunction(new VariableExpression("v1"))), new CompositeStatement(new ForkStatement(new CompositeStatement(new AcquireStatement("cnt"), new CompositeStatement(new WriteHeapStatement(new VariableExpression("v1"), new BinaryExpression(new ReadHeapFunction(new VariableExpression("v1")),new ConstantExpression(new IntegerValue(10)),"*")), new CompositeStatement(new PrintStatement(new ReadHeapFunction(new VariableExpression("v1"))), new ReleaseStatement("cnt"))))), new CompositeStatement(new ForkStatement(new CompositeStatement(new AcquireStatement("cnt"), new CompositeStatement(new WriteHeapStatement(new VariableExpression("v1"), new BinaryExpression(new ReadHeapFunction(new VariableExpression("v1")),new ConstantExpression(new IntegerValue(10)),"*")), new CompositeStatement(new WriteHeapStatement(new VariableExpression("v1"), new BinaryExpression(new ReadHeapFunction(new VariableExpression("v1")),new ConstantExpression(new IntegerValue(2)),"*")), new CompositeStatement(new PrintStatement(new ReadHeapFunction(new VariableExpression("v1"))), new ReleaseStatement("cnt")))))), new CompositeStatement(new AcquireStatement("cnt"), new CompositeStatement(new PrintStatement(new BinaryExpression(new ReadHeapFunction(new VariableExpression("v1")),new ConstantExpression(new IntegerValue(1)),"-")), new ReleaseStatement("cnt")))))))))
    ));
}