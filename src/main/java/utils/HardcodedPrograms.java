                                            ...
                                            new CompositeStatement(
                                                    ...
                                                    new CompositeStatement(
                                                            ...
                                                            new CompositeStatement(
                                                                            ...
                                                                            new CompositeStatement(
                                                                                    new ForkStatement(
                                                                                            new CompositeStatement(
                                                                                                    new LockStatement("x"),
                                                                                                    new CompositeStatement(
                                                                                                            new WriteHeapStatement(new VariableExpression("v1"), new BinaryExpression(new ReadHeapFunction(new VariableExpression("v1")), new ConstantExpression(new IntegerValue(1)), "-")),
                                                                    ...
                                                                    new CompositeStatement(
                                                                            new ForkStatement(new NoOperationStatement()),
                                                                            new CompositeStatement(
                                                                                    new ForkStatement(
                                                                                            new WriteHeapStatement(new VariableExpression("v2"), new BinaryExpression(new ReadHeapFunction(new VariableExpression("v2")), new ConstantExpression(new IntegerValue(1)), "+"))
                                                                                    ),
                                                                                    new CompositeStatement(
                                                                                            new WriteHeapStatement(new VariableExpression("v2"), new BinaryExpression(new ReadHeapFunction(new VariableExpression("v2")), new ConstantExpression(new IntegerValue(1)), "+")),
                                                                                            new CompositeStatement(
