...
public class MainView implements IMainView {
    ...
    public void displayMenu() {
        System.out.println("1) Ref string v;new(v,20);Ref Ref int a; new(a,v);print(v);print(a)");
